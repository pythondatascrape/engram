...
var (
	anthropicResponseCodebook = mustDeriveCodebook("anthropic_response", map[string]string{
		"role":          "enum:assistant",
	...
	openaiResponseCodebook = mustDeriveCodebook("openai_response", map[string]string{
		"role":              "enum:assistant",
...
func mustDeriveCodebook(name string, schema map[string]string) *ContextCodebook {
	...
	if err != nil {
		panic("response_codebook: " + err.Error())
	}
	return cb
}

// AnthropicResponseCodebook returns the built-in ContextCodebook for Anthropic response fields.
func AnthropicResponseCodebook() *ContextCodebook { return anthropicResponseCodebook }

// OpenAIResponseCodebook returns the built-in ContextCodebook for OpenAI response fields.
func OpenAIResponseCodebook() *ContextCodebook { return openaiResponseCodebook }
